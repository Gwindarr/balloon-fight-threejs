...
import { triggerMushroomBounce } from './environment.js';
import {
    GROUND_LEVEL,
    PLAYER_HEIGHT,
    PLAYER_RADIUS,
...
export class CollisionSystem {
    ...
    static checkSpecialPlatformCollisions(entity) {
        ...
        for (const mushroom of boostMushrooms) {
            ...
            const scaleFactor = mushroom.scale.x;
            const mushroomCapRadius = mushroom.userData.capRadius * scaleFactor;
            const stemHeight = mushroom.userData.stemHeight * scaleFactor;
